...
## GMM {background-video="IMG_5249.MOV" background-video-loop="true" background-video-muted="true" background-size="contain"}
...
$\exits \theta_0 \in \Theta$ s.t. $\forall \epsilon>0$,
$$
