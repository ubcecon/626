...
In "As the Wind Blows: The Effects of Long-Term Exposure to Air Pollution on Mortality", @anderson2019 estimates the effect of air pollution on mortality and other health outcomes. Anderson uses data on census-block mortality, location, and highway locations to estimate
...
$$
\sqrt{n} (\hat{\beta} \sqrt{\hat{\sigma}^2} - \beta\sigma) \indist N\left(0, \sigma^2\Er[w^2]^{-2} \var(w\epsilon)+ \frac{\beta^2}{4 \sigma^2} \var((w_i - \Er[w])^4)\right)
$$
