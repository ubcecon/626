...
$$
\Er[y_{it}|t, D_{i1}=d_1, ..., D_{iT}=d_T] = \sum{c, s} \beta_{c,s} \mathbbm{1}\{cohort(i)=c,s=t\}
$$
...
- Understand existing methods: read reviews @dd2022, @roth2023, @dd2023, @wing2024
...
- Book: @dd2023
- Recent reviews: @roth2023, @dd2022, @arkhangelsky2023, @wing2024
