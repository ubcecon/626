...
2. Derive the Cramér Rao lower bound for any unbiased estimator for
$\theta$. Is $2 \bar{X}$ a minimum variance unbiased estimator?

3. Show that $\hat{\theta} = \frac{n+1}{n} \max_{1 \leq i \leq n} X_i$ is a minimum variance unbiased estimator for $\theta$.
